...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    createYourOwnSkillDescription:
      "Create your own skill to release the power of MAgent. With customized skills,\nMAgent can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. MAgent is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but MAgent could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "MAgent's official website",
    githubTooltip: "MAgent on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "MAgent on GitHub",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to MAgent",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate MAgent faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how MAgent looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "MAgent automatically learns from your conversations in the background. These memories help MAgent understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of MAgent.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "MAgent only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
